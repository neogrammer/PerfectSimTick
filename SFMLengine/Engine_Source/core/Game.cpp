...
void Game::run()
{
    ...
    sf::Vector2f playerPos{ 300.f, 125.f };
    
    Assets::Textures curBody = Assets::Textures::Knight_Idle;
    Assets::Textures curShadow = Assets::Textures::Knight_Idle_Shadow;
    while (wnd.isOpen())
    {
    	pollWindow(wnd);
        input();
